...
import type { MapMode, OfflineMapManifest, OfflineMapPackage } from '$lib/map/types';
import { apiError, apiSuccess } from '$lib/server/api';
import { getRuntimeConfig, type RuntimeConfig } from '$lib/server/env';
...
function packagePaths(config: RuntimeConfig, mode: MapMode): string[] {
